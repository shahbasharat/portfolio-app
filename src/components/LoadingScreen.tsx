    ...
    <AnimatePresence>
      {loading && (
        <motion.div
          ...
          className="fixed inset-0 z-[99999] bg-black flex flex-col items-center justify-center px-6"
        >
          {/* Grid background */}
          <div
          ...
          {/* Blue glow */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[280px] h-[280px] md:w-[400px] md:h-[400px] bg-blue-900/20 rounded-full blur-[100px] pointer-events-none" />
          ...
          <div className="relative z-10 flex flex-col items-center w-full max-w-sm mx-auto">
            ...
            <motion.div
              ...
              className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center mb-6 md:mb-8"
            >
            ...
            <motion.h1
              ...
              className="text-2xl sm:text-3xl md:text-5xl font-black tracking-tighter text-white mb-2 text-center"
            >
              Basharat Salam
            </motion.h1>
